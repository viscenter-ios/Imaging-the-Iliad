...
struct IApplicationEngine {
	...
	virtual void updateView( const std::string & folio ) = 0;
...
namespace ParametricViewer { IApplicationEngine* CreateApplicationEngine(IRenderingEngine*, IResourceManager*); }
