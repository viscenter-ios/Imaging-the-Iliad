...
- (CGImageRef) imageForPageIndex:(NSUInteger)pageIndex {
	...
	NSLog(@"- (CGImageRef) imageForPageIndex:(NSUInteger)pageIndex { %i", pageIndex);
	...
	//}
	//else {
	//	[dataSource renderPageAtIndex:pageIndex-2 inContext:context];
	//}
...
- (void) precacheImageForPageIndexNumber:(NSNumber *)pageIndexNumber {
	...
	//not called before above function?
